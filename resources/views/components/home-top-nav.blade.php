<nav x-data="{ isOpen: false, searchBox: false }" class="relative bg-white shadow dark:bg-gray-800">
    <div class="container px-0 lg:px-6 py-3 mx-auto md:flex">
        <div class="flex justify-between items-center px-5">
            <div>
                <a class="text-xl font-bold text-gray-800 transition-colors duration-300 transform dark:text-white hover:text-gray-700 dark:hover:text-gray-300" href="#">
                    <div class="flex items-center">
                        <img src="{{asset('logo.png')}}" alt="" class="h-14 w-14 rounded-full">
                        <p x-show="!searchBox" class="ml-0">DealsDay</p>
            ...
            <div class="flex lg:hidden">
                <button x-cloak @click="searchBox = !searchBox" class="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400 mr-2">
        ...
        <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 md:mt-0 md:p-0 md:top-0 md:relative md:opacity-100 md:translate-x-0 md:flex md:items-center md:justify-between">
            <div class="flex flex-col px-2 -mx-4 md:flex-row md:mx-2 md:py-0">
